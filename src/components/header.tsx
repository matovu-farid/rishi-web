    ...
    <header className="border-b border-border bg-background/80 backdrop-blur-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a href="#howitworks" className="text-sm text-muted-foreground hover:text-foreground transition">How it Works</a>
      ...
      {isOpen && (
        <div className="md:hidden border-t border-border px-6 py-4 space-y-3">
          ...
          <a href="#howitworks" className="block text-sm text-muted-foreground hover:text-foreground transition">How it Works</a>
